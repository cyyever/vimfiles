...
let b:ale_python_pylint_options = "--disable=missing-docstring --disable=invalid-name --disable=too-few-public-methods --disable=broad-except --disable=bad-continuation --disable=wrong-import-position --disable=ungrouped-imports --disable=relative-beyond-top-level --disable=redefined-outer-name --disable=protected-access --generated-members='numpy.*,torch.*'"
