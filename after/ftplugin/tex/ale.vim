...
if filereadable(b:textidote_jar)
  let g:ale_tex_textidote_executable='java'
  let g:ale_tex_textidote_options='-jar '.b:textidote_jar.' --no-color --output singleline '
  let g:ale_tex_textidote_check_lang='en'
endif
